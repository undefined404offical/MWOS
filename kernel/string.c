...
static void append_uint(char **buf, size_t *remaining,
                        unsigned long long v, int base, bool uppercase)
{
    char tmp[32];
    int pos = 0;
...
int vsnprintf(char *str, size_t size, const char *fmt, va_list args)
{
    ...
    while (*fmt)
    {
        ...
        case 'd':
        {
            ...
            append_uint(&t, &(size_t){sizeof(temp)}, (unsigned long long)v, 10, false);
            break;
        }
